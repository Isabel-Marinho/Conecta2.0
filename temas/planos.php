...
<html>
    ...
    <body>
        ...
        // Selecionando os projetos de capacitação //
            ...
            $plano = "%".trim('plano de ação')."%";

            $sth = $dbh->prepare("SELECT * FROM projetos
            WHERE temas LIKE :plano ORDER BY visitas LIMIT 15 ");
            
            $sth->bindParam(':plano', $plano, PDO::PARAM_STR);
            $sth->execute();
  ...
  <div class="swiper mySwiper">
      <h1 class="titulo-temas">Soluções em Planos de Ação</h1>
      <br><br>
