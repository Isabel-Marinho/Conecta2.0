...
<html>
    ...
    <body>
        ...
        // Selecionando os projetos de capacitação //
            ...
            WHERE temas LIKE :diagnostico ORDER BY visitas LIMIT 15 ");
            
            $sth->bindParam(':diagnostico', $diagnostico, PDO::PARAM_STR);
            $sth->execute();
  ...
  <div class="swiper mySwiper">
      <h1 class="titulo-temas">Soluções em Diagnósticos</h1>
      <br><br>
