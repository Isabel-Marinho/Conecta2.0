...
<html>
    ...
    <body>
        ...
        // Selecionando os projetos de capacitação //
            ...
            $projeto = "%".trim('projeto')."%";

            $sth = $dbh->prepare("SELECT * FROM projetos
            WHERE temas LIKE :projeto ORDER BY visitas LIMIT 15 ");
            
            $sth->bindParam(':projeto', $projeto, PDO::PARAM_STR);
            $sth->execute();
  ...
  <div class="swiper mySwiper">
      <h1 class="titulo-temas">Soluções em Políticas Públicas</h1>
      <br><br>
