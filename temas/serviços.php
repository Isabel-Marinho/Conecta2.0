...
<html>
    ...
    <body>
        ...
        // Selecionando os projetos de capacitação //
            ...
            $servicos = "%".trim('serviço')."%";

            $sth = $dbh->prepare("SELECT * FROM projetos
            WHERE temas LIKE :servicos ORDER BY visitas LIMIT 15 ");
            
            $sth->bindParam(':servicos', $servicos, PDO::PARAM_STR);
            $sth->execute();
  ...
  <div class="swiper mySwiper">
      <h1 class="titulo-temas">Soluções em Serviços</h1>
      <br><br>
