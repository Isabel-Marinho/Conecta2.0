...
<html>
    ...
    <body>
        ...
        <div class="conteudo_proj">
            <h1 class="titulo_projeto"> Atendimento Multidisciplinar de Pacientes com Dor Crônica </h1>
            <br>
                <p class="conteudo">
                ...
                fluminense. PROJETOS ESTRATÉGICOS ASSISTENCIAIS-DOR CRONICA.
                </p>
               
            <p class="conteudo2">
        Palavas-chave: dor; cronica;
            <br><br>
        Unidade Acadêmica: Faculdade de Ciências Médicas
            <br><br>
        Pesquisador Responsável: Nivaldo Ribeiro Villela
            <br><br>
